...
from knowledge_rag.service.minio_service import MinioService
from knowledge_rag.vo.minio_vo import (
    MinioDownloadReqVo,
    MinioDownloadRespVo,
...
@router.post(
    '/upload/local',
    dependencies=[UserInterfaceAuthDependency('knowledge_rag:minio:upload:local')],
...
@router.post(
    '/upload/stream',
    dependencies=[UserInterfaceAuthDependency('knowledge_rag:minio:upload:stream')],
    response_model=DataResponseModel[MinioUploadRespVo],
)
...
@router.post(
    '/download',
    dependencies=[UserInterfaceAuthDependency('knowledge_rag:minio:download')],
