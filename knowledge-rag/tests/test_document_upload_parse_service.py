...
from knowledge_rag.vo.document_upload_parse_vo import HandleParseDecisionModel, UploadDocumentModel
...
class TestHandleParseDecision:
    ...
    async def test_decision_delete_success(self):
        ...
        with (
            ...
            patch(
                'knowledge_rag.service.document_upload_parse_service.KnowledgeDocumentDao.get_document_by_record_id',
                new_callable=AsyncMock,
                return_value=None,
            ),
            patch(
                'knowledge_rag.service.document_upload_parse_service.KnowledgeUploadRecordDao.soft_delete',
                new_callable=AsyncMock,
            ) as mock_delete_record,
            patch(
                'knowledge_rag.service.document_upload_parse_service.KnowledgeMineruParseTaskDao.soft_delete_by_record_id',
                new_callable=AsyncMock,
            ) as mock_delete_task,
            patch(
                'knowledge_rag.service.document_upload_parse_service.RequestContext.get_current_user',
