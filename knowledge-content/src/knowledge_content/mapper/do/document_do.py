...
class KnowledgeDocument(Base):
    ...
    source_url = Column(Text, nullable=True, comment='网页来源URL')
    ...
    doc_version = Column(String(20), nullable=True, server_default='1.0', comment='文档版本')
    ...
    media_count = Column(Integer, nullable=True, server_default='0', comment='媒体文件数量')
