...
class UserInfoModel(UserModel):
    ...
    role: list[RoleModel | None] | None = Field(default=list, description='角色信息')
...
class AddUserModel(UserModel):
    ...
    role_ids: list | None = Field(default=list, description='角色ID信息')
    post_ids: list | None = Field(default=list, description='岗位ID信息')
...
class EditUserModel(AddUserModel):
    ...
    role: list | None = Field(default=list, description='角色信息')
...
class UserRoleResponseModel(BaseModel):
    ...
    roles: list[SelectedRoleModel | None] = Field(default=list, description='角色信息')
