...
class JobModel(BaseModel):
    ...
    app_scope: str | None = Field(default=None, description='任务所属应用（knowledge-admin/knowledge-content/knowledge-agent）')
...
class JobPageQueryModel(JobQueryModel, BasePageQueryModel):
    """
    定时任务管理分页查询模型
    """
...
class JobLogPageQueryModel(JobLogQueryModel, BasePageQueryModel):
    """
    定时任务日志管理分页查询模型
    """
