...
class AiModelModel(BaseModel):
    ...
    support_images: Literal['Y', 'N'] | None = Field(default=None, description='是否支持图片/图像输入')
    support_text_inputs: Literal['Y', 'N'] | None = Field(default=None, description='是否支持文本输入')
    support_audio_inputs: Literal['Y', 'N'] | None = Field(default=None, description='是否支持音频输入')
    support_video_inputs: Literal['Y', 'N'] | None = Field(default=None, description='是否支持视频输入')
    support_text_outputs: Literal['Y', 'N'] | None = Field(default=None, description='是否支持文本输出')
    support_image_outputs: Literal['Y', 'N'] | None = Field(default=None, description='是否支持图像输出')
    support_audio_outputs: Literal['Y', 'N'] | None = Field(default=None, description='是否支持音频输出')
    support_video_outputs: Literal['Y', 'N'] | None = Field(default=None, description='是否支持视频输出')
    support_tool_call: Literal['Y', 'N'] | None = Field(default=None, description='是否支持工具调用')
    support_tool_choice: Literal['Y', 'N'] | None = Field(default=None, description='是否支持工具选择')
    support_structured_output: Literal['Y', 'N'] | None = Field(default=None, description='是否支持结构化输出')
    support_image_url_inputs: Literal['Y', 'N'] | None = Field(default=None, description='是否支持图像URL输入')
    support_pdf_inputs: Literal['Y', 'N'] | None = Field(default=None, description='是否支持PDF输入')
    support_pdf_tool_message: Literal['Y', 'N'] | None = Field(default=None, description='是否支持PDF工具消息')
    support_image_tool_message: Literal['Y', 'N'] | None = Field(default=None, description='是否支持图像工具消息')
