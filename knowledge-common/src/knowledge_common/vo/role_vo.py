...
class RolePageQueryModel(RoleQueryModel, BasePageQueryModel):
    """
    角色管理分页查询模型
    """
...
class RoleMenuQueryModel(BaseModel):
    ...
    menus: list = Field(default=list, description='菜单信息')
    checked_keys: list[int] = Field(default=list, description='已选择的菜单ID信息')
...
class RoleDeptQueryModel(BaseModel):
    ...
    depts: list = Field(default=list, description='部门信息')
    checked_keys: list[int] = Field(default=list, description='已选择的部门ID信息')
...
class AddRoleModel(RoleModel):
    ...
    dept_ids: list = Field(default=list, description='部门ID信息')
    menu_ids: list = Field(default=list, description='菜单ID信息')
