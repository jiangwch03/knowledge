...
from knowledge_admin.module_admin.entity.do.notice_do import SysNotice
from knowledge_admin.module_admin.entity.vo.notice_vo import NoticeModel, NoticePageQueryModel
