...
from knowledge_admin.module_admin.entity.vo.login_vo import LoginToken, RouterModel, Token, UserLogin, UserRegister
from knowledge_common.entity.vo.user_vo import CurrentUserModel, EditUserModel
from knowledge_admin.module_admin.service.login_service import CustomOAuth2PasswordRequestForm, LoginService, oauth2_scheme
